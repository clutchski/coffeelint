...
(function() {
  ...
  ASTLinter = (function() {
    ...
    ASTLinter.prototype.lint = function() {
      ...
      this.checkEofNewlines();
      return this.errors;
    };

    ASTLinter.prototype.checkEofNewlines = function() {
      var attrs, error, rule, _ref, _ref1;
      rule = 'no_eof_newline';
      if (this.source.substr(-1) !== '\n') {
        attrs = {
          message: (_ref = this.config[rule]) != null ? _ref.message : void 0,
          level: (_ref1 = this.config[rule]) != null ? _ref1.level : void 0
        };
